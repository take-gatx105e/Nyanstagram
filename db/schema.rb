...
ActiveRecord::Schema.define(version: 2020_11_04_035127) do
  ...
  create_table "cat_images", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "cat_id"
    t.string "alt_text"
    t.integer "position"
    t.datetime "created_at", null: false
  ...
  create_table "favorites", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_id", "cat_id"], name: "index_favorites_on_user_id_and_cat_id", unique: true
